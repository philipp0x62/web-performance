...
for index, resolver in df_resolvers.iterrows():
   ...
   # DoQ
    if support_doq:
        ...
        #TODO muss ich dafür nicht die Messung nochmal machen? d.h. einmal direkt zum resolver, damit der DNS Eintrag hinterlegt ist, einmal um die Zeit zu messen und einmal um die Verändeurng zu messen
